...
dump(X_scaler, open('X_scaler_WindPower.pkl', 'wb'))
dump(y_scaler, open('y_scaler_WindPower.pkl', 'wb'))
...
np.save("X_train_WindPower.npy", X_train)
np.save("y_train_WindPower.npy", y_train)
np.save("X_test_WindPower.npy", X_test)
np.save("y_test_WindPower.npy", y_test)
np.save("yc_train_WindPower.npy", yc_train)
np.save("yc_test_WindPower.npy", yc_test)
np.save('index_train_WindPower.npy', index_train)
np.save('index_test_WindPower.npy', index_test)
np.save('train_predict_index_WindPower.npy', index_train)
np.save('test_predict_index_WindPower.npy', index_test)
