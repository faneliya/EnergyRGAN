...
# %% --------------------------------------- Load Data  -----------------------------------------------------------------
dataset = pd.read_csv('SunData_with_Fourier.csv', parse_dates=['DATE'])
...
dataset.to_csv("datasetSun.csv", index=False)
# Add News data 제거함
...
dump(X_scaler, open('X_scaler_sun.pkl', 'wb'))
dump(y_scaler, open('y_scaler_sun.pkl', 'wb'))
...
np.save("X_train_sun.npy", X_train)
np.save("y_train_sun.npy", y_train)
np.save("X_test_sun.npy", X_test)
np.save("y_test_sun.npy", y_test)
np.save("yc_train_sun.npy", yc_train)
np.save("yc_test_sun.npy", yc_test)
np.save('index_train_sun.npy', index_train)
np.save('index_test_sun.npy', index_test)
np.save('train_predict_index_sun.npy', index_train)
np.save('test_predict_index_sun.npy', index_test)
