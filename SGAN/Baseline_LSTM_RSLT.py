...
model= tensorflow.keras.models.load_model('LSTM_3to1.h5')
print(model.summary())
...
def plot_traindataset_result(X_train, y_train):
    ...
    print("debug 3 , range = " + str(rescaled_predicted_y.shape[0]))
    ...
    print("debug 4 , range =" +  str(rescaled_real_y.shape[0]))
