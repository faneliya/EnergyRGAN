...
# Load data
X_train = np.load("X_train_sun.npy", allow_pickle=True)
y_train = np.load("y_train_sun.npy", allow_pickle=True)
X_test = np.load("X_test_sun.npy", allow_pickle=True)
y_test = np.load("y_test_sun.npy", allow_pickle=True)
yc_train = np.load("yc_train_sun.npy", allow_pickle=True)
yc_test = np.load("yc_test_sun.npy", allow_pickle=True)
...
def plot_traindataset_result(X_train, y_train):
    ...
    y_scaler = load(open('y_scaler_sun.pkl', 'rb'))
    train_predict_index = np.load("train_predict_index_sun.npy", allow_pickle=True)
...
def plot_testdataset_result(X_test, y_test):
    ...
    y_scaler = load(open('y_scaler_sun.pkl', 'rb'))
    test_predict_index = np.load("test_predict_index_sun.npy", allow_pickle=True)
...
'''def plot_last3_testdataset_result(X_test, y_test):
    ...
    #print("----- test dataset rescaled Predicted Value -----", rescaled_predicted_y)
    #print("----- test dataset SHAPE rescaled Predicted Value -----", rescaled_predicted_y.shape)
